return {
  name="Ground debug",  --The name of this mod, displayed on the list in game
  description="Gives access to the ground debug menu.",  --A short description of this mod, displayed on the list in game
